        ...
        <div className="container mx-auto px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            {user ? (
              ...
              <Link
                to="/login"
                className="px-4 py-2 text-sm font-medium bg-linear-to-r from-blue-600 to-indigo-600 text-white rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all"
              >
                Login
              </Link>
            )}
