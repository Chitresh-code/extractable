...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 overflow-hidden">
      ...
      <nav className="border-b border-slate-200/80 bg-white/70 backdrop-blur-xl sticky top-0 z-50 shadow-sm">
        <div className="container mx-auto px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              to="/register"
              className="px-5 py-2 text-sm font-medium bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
            >
              Get Started
            </Link>
          </div>
      ...
      {/* Hero Section */}
      <section className="container mx-auto px-6 lg:px-8 pt-24 pb-20 text-center relative">
        <div className="max-w-5xl mx-auto">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 mb-8 bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-700 rounded-full text-sm font-medium border border-blue-200/50 shadow-sm animate-fade-in">
          ...
          {/* Main Heading */}
          <h1 className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold mb-8 leading-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <Link
              to="/register"
              className="group relative px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 font-semibold text-lg shadow-xl hover:shadow-2xl transform hover:-translate-y-1 hover:scale-105 overflow-hidden"
            >
          ...
          <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto pt-8 border-t border-slate-200">
            ...
            <div>
              ...
              <div className="text-sm text-slate-600 mt-1">Processing</div>
            </div>
            <div>
              <div className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                24/7
          ...
          {[
            {
              ...
              description: 'Extract tables from PDFs and images in seconds with our AI-powered pipeline. No more manual data entry or waiting hours for results.',
            },
            {
              icon: (
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            },
            {
              ...
              description: 'Export your data as JSON, CSV, or Excel - whatever format works best for your workflow. Seamless integration with your tools.',
            },
          ].map((feature, idx) => (
            <div
              key={idx}
      ...
      {/* How It Works */}
      <section className="container mx-auto px-6 lg:px-8 py-24 relative">
        <div className="bg-gradient-to-br from-slate-50 via-blue-50/50 to-indigo-50/30 rounded-3xl p-12 md:p-16 shadow-xl border border-slate-200/50">
          ...
          <div className="grid md:grid-cols-5 gap-6 max-w-6xl mx-auto relative">
            {[
              { num: 1, title: 'Upload', desc: 'Upload your PDF or image files', icon: '📤' },
              { num: 2, title: 'Extract', desc: 'AI extracts tables automatically', icon: '🤖' },
              { num: 3, title: 'Validate', desc: 'Multi-pass validation ensures accuracy', icon: '✅' },
              { num: 4, title: 'Refine', desc: 'Final consolidation and refinement', icon: '✨' },
              { num: 5, title: 'Download', desc: 'Get your structured data', icon: '📥' },
            ].map((step, idx) => (
              <div key={step.num} className="text-center relative group">
                <div className="mb-6 relative">
                  <div className="w-20 h-20 bg-gradient-to-br from-blue-600 to-indigo-600 text-white rounded-2xl flex items-center justify-center mx-auto font-bold text-2xl shadow-lg group-hover:scale-110 group-hover:shadow-xl transition-all duration-300">
                    {step.num}
                  </div>
                ...
                {idx < 4 && (
                  <div className="hidden md:block absolute top-10 left-[calc(50%+2.5rem)] w-[calc(100%-5rem)] h-1 bg-gradient-to-r from-blue-600/30 via-indigo-600/30 to-blue-600/30 -z-10 rounded-full" />
                )}
      ...
      <section className="container mx-auto px-6 lg:px-8 py-24">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {[
            {
              quote: 'Extractable saved us hours of manual data entry. The accuracy is incredible!',
              author: 'Sarah Chen',
              role: 'Data Analyst',
              company: 'TechCorp',
            },
            {
              quote: 'The multi-format export feature is a game-changer for our workflow.',
              author: 'Michael Rodriguez',
              role: 'Operations Manager',
              company: 'DataFlow Inc',
            },
            {
              quote: 'Fast, accurate, and reliable. Everything we needed in one platform.',
            ...
            <div
              key={idx}
              className="bg-white p-8 rounded-2xl border border-slate-200 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
            >
      ...
      <section className="container mx-auto px-6 lg:px-8 py-24 text-center">
        <div className="max-w-4xl mx-auto relative">
          <div className="bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 rounded-3xl p-12 md:p-16 shadow-2xl overflow-hidden relative">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed max-w-2xl mx-auto">
                Join thousands of users extracting tables with Extractable. Start your free trial today - no credit card required.
              </p>
