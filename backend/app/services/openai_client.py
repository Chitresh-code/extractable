...
class OpenAIClient:
    ...
    def __init__(self):
        ...
        logger.info(f"OpenAI client initialized with models: simple={self.model_names['simple']}, regular={self.model_names['regular']}, complex={self.model_names['complex']}")
    ...
    async def generate_content(
        ...
        complexity: ComplexityLevel = "regular"
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            response = await asyncio.to_thread(
                self._call_openai_with_retry, prompt, images, complexity
            )
    ...
    def parse_json_response(self, response_text: str) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                raise ValueError(f"Failed to parse JSON response: {str(e)}. Text length: {len(text)}, First 500 chars: {text[:500]}")
